...
`pnb_savings-may-2023.txt` is the anonymised text layer of a real Punjab
National Bank statement, copied from the Apache-2.0 project
[`raptar231/indian-bank-statement-parser`](https://github.com/raptar231/indian-bank-statement-parser)
(`tests/fixtures/pnb/`). It is used only to verify
`settleflow.parsers.parse_bank_text` against the real PNB collapsed-column
